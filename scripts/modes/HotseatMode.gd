...
static func can_begin_keyboard_charge(keyboard_down: bool, keyboard_held: bool, projectile_active: bool, turn_projectiles: Array[Dictionary], game_over: bool, overlay_open: bool) -> bool:
	return keyboard_down and not keyboard_held and can_begin_charge(projectile_active, turn_projectiles, game_over, overlay_open)

static func should_release_keyboard_charge(keyboard_down: bool, keyboard_held: bool) -> bool:
